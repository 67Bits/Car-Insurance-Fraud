        ...
        public void SetState(State newState)
        {
            ...
            switch (newState)
            {
                ...
                case State.Puppet:
                    ...
                    character_movement.canMove = true;
                    character_movement.air = false;
                    character_movement.speed = character_movement.speed_normal;

                    control_camera = GameObject.FindGameObjectWithTag("cameraController").GetComponent<Animator>();

                    control_camera.ResetTrigger("1");
                    control_camera.SetTrigger("2");
                    break;
                ...
                case State.Unpinned:
                    ...
                    character_movement.canMove = true;
                    character_movement.air = true;
                    character_movement.Invoke("activarChocarPiso", 0.1f);
                    character_movement.speed = character_movement.speed_air;

                    //if (!control_nivel.increment_active)
                    //{
                    control_nivel.startIncrementCoin();
                    //}

                    control_camera.ResetTrigger("2");
                    control_camera.SetTrigger("1");
                ...
                case State.GetUp:
                    ...
                    character_movement.canMove = false;
